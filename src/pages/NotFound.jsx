...
const NotFound = () => {
    return(
        <div className="mt-5 text-center alreadyLoggedBackground mx-auto">
            ...
            <p className="mt-3" style={{fontFamily: "'Poppins', sans-serif", fontSize: "1.5em"}}>Se não está feliz com isso, mande-nos uma reclamação em nossa página de contato clicando <Link to="/contact" style={{textDecoration: "none"}}>aqui</Link>.</p>
